...
PHONE_TIME_THRESHOLD = 5
DISTRACTION_FRAME_THRESHOLD = 300
...
FRAME_WINDOW = st.image([])        # live video placeholder
alert_placeholder = st.empty()     # alerts placeholder
...
if start_cam:
    ...
    while True:
        ...
        # Distraction
        if (st.session_state.phone_start_time is None and
            not awake_detected and not drowsy_detected):
